...
public abstract class MixinBlockModelRenderer {
    ...
    /**
     * @author White_cola
     * @reason fix the NPE to anti ArrayIndexOutOfBoundsException bug.
     */
    @Overwrite
    public boolean renderModel(IBlockAccess p_renderModel_1_, IBakedModel p_renderModel_2_, IBlockState p_renderModel_3_, BlockPos p_renderModel_4_, WorldRenderer p_renderModel_5_, boolean p_renderModel_6_) {
        boolean flag = Minecraft.isAmbientOcclusionEnabled() && p_renderModel_3_.getBlock().getLightValue() == 0 && p_renderModel_2_.isAmbientOcclusion();
